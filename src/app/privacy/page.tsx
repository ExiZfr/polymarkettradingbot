        ...
        <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white overflow-x-hidden">
            ...
            <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                <div className="prose dark:prose-invert prose-lg max-w-none">
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">3. Use of Your Information</h2>
                        <p className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            If you have questions or comments about this Privacy Policy, please contact us at: <a href="mailto:privacy@polygraalx.app" className="text-blue-600 dark:text-blue-500 hover:underline">privacy@polygraalx.app</a>
                        </p>
                    </section>
                </div>
            </main>
