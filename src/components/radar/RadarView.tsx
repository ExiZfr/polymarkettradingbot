            ...
            <div className="sticky top-4 z-40 mb-8 p-1.5 bg-[#0C0D12]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl flex flex-col md:flex-row gap-2 overflow-visible">
                ...
                <div className="flex items-center gap-2 overflow-visible pb-1 md:pb-0 px-2 md:px-0">
                    ...
                    <div className="relative">
                        ...
                        {openFilter === 'category' && (
                            <div className="absolute top-full left-0 mt-2 w-40 bg-[#15171E] border border-white/10 rounded-xl shadow-xl p-1 z-[9999]">
                    ...
                    <div className="relative">
                        ...
                        {openFilter === 'type' && (
                            <div className="absolute top-full left-0 mt-2 w-48 bg-[#15171E] border border-white/10 rounded-xl shadow-xl p-1 z-[9999]">
