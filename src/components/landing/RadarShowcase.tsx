            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        <div className="w-full h-full bg-linear-to-br from-slate-900 to-black flex items-center justify-center p-8 rounded-2xl border border-border">
                            <Radar size={120} className="text-primary/20 animate-pulse" />
                        </div>
                    </div>
                </div>
            </div>
